...
#reading image
image_read = cv.imread('huamn.png', 1)   
...
histogram = [0]*256
#function to calculate binary pattern
def threshold(image,centre,i,j):     
        binary =[]
        ...
        if (image[i ][j - 1]) < centre:
            ...
            binary.append(1)
        return binary
#function to calculate value of centre pixel on basis of LSB pattern
def calculate_value (binary_array):                   
    final_value =0
